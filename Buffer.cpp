...
COORD Buffer::getSize() const { return size; }

COORD Buffer::getCoord() const { return coord; }

SMALL_RECT* Buffer::getWriteRegion() { return &writeRegion; }

std::vector<CHAR_INFO>& Buffer::getScreenBuffer() { return screenBuffer; }

CHAR_INFO * Buffer::getRawData() { return screenBuffer.data(); }
